...
<head>
    ...
    <title>K&G Brewed Coffee Shop</title>
...
<body>
    ...
    <section class="home" id="home">
        <div class="content">
            <h3>Welcome to K&G Coffee Shop, <?php echo $_SESSION['username']; ?>!</h3>
            <p>
    ...
    <section class="about" id="about">
        ...
        <div class="row g-0">
            ...
            <div class="content">
                <h3>Welcome to K&G!</h3>
                <p>
                    At K&G Coffee Shop, we are passionate about coffee and believe
                ...
                <p>
                    ...
                    inviting atmosphere at K&G is designed to be a haven
    ...
    <section class="contact" id="contact">
        ...
        <div class="row">
            ...
            <form name="contact" method="POST" action="https://formspree.io/f/xdoqbyrl">
    ...
    <section class="footer">
        <div class="footer-container">
            ...
            <div class="credit">
                <hr /><br />
                <h2>K&G Brewed Coffee © 2023 | All Rights Reserved.</h2>
                <h2>Designed by <span>K&G</span> | Teravision</h2>
            </div>
        </div>
    </section>
    ...
    <script src="../assets/js/productsJS/indexLoggedIn.js"></script>
